#!/usr/bin/env python3
"""
Integration tests for kinetidiff guidance modules.

Run with:
    python -m pytest tests/integration/test_guidance_integration.py -v
    python -m pytest tests/integration/test_guidance_integration.py -v -m vina
"""
...
def test_scoring_utils():
    ...
    from kinetidiff.utils.scoring_utils import (
        compute_fop_score,
...
def run_all_tests():
    """Run all tests."""
    print("=" * 60)
    print("KINETIDIFF GUIDANCE INTEGRATION TESTS")
    print("=" * 60)
