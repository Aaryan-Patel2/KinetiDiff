...
try:
    ...
    # Create dummy functions if torch_scatter not available
...
# Handle BioPython version compatibility
try:
...
import utils
from analysis.metrics import BasicMolecularMetrics, CategoricalDistribution, check_stability
from analysis.molecule_builder import build_molecule, process_molecule
from analysis.visualization import save_xyz_file, visualize, visualize_chain
from equivariant_diffusion.conditional_model import ConditionalDDPM, SimpleConditionalDDPM
